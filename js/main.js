...
function isMoveHeaderBtn() {
  const headerBtn = document.querySelector('.header .btn__wrapper');
  ...
  } else if (headerBtn && blockBtnDesctop && blockBtnmob && window.innerWidth <= 850) {
    blockBtnmob.append(headerBtn);
  }
}
isMoveHeaderBtn();
...
window.addEventListener('resize', isMoveHeaderBtn);
